...
func (c *FakeJwtConfigs) Get(name string, options v1.GetOptions) (result *policiesv1.JwtConfig, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(jwtconfigsResource, c.ns, name), &policiesv1.JwtConfig{})

	if obj == nil {
		return nil, err
	}
	return obj.(*policiesv1.JwtConfig), err
}
...
func (c *FakeJwtConfigs) List(opts v1.ListOptions) (result *policiesv1.JwtConfigList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(jwtconfigsResource, jwtconfigsKind, c.ns, opts), &policiesv1.JwtConfigList{})
	...
	list := &policiesv1.JwtConfigList{ListMeta: obj.(*policiesv1.JwtConfigList).ListMeta}
	for _, item := range obj.(*policiesv1.JwtConfigList).Items {
...
func (c *FakeJwtConfigs) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(jwtconfigsResource, c.ns, opts))
...
func (c *FakeJwtConfigs) Create(jwtConfig *policiesv1.JwtConfig) (result *policiesv1.JwtConfig, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(jwtconfigsResource, c.ns, jwtConfig), &policiesv1.JwtConfig{})
...
func (c *FakeJwtConfigs) Update(jwtConfig *policiesv1.JwtConfig) (result *policiesv1.JwtConfig, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(jwtconfigsResource, c.ns, jwtConfig), &policiesv1.JwtConfig{})
...
func (c *FakeJwtConfigs) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(jwtconfigsResource, c.ns, name), &policiesv1.JwtConfig{})
...
func (c *FakeJwtConfigs) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(jwtconfigsResource, c.ns, listOptions)

	_, err := c.Fake.Invokes(action, &policiesv1.JwtConfigList{})
	return err
}
...
func (c *FakeJwtConfigs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *policiesv1.JwtConfig, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(jwtconfigsResource, c.ns, name, pt, data, subresources...), &policiesv1.JwtConfig{})
