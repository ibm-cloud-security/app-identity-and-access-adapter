...
func (c *FakePolicies) Get(name string, options v1.GetOptions) (result *policiesv1.Policy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(policiesResource, c.ns, name), &policiesv1.Policy{})

	if obj == nil {
		return nil, err
	}
	return obj.(*policiesv1.Policy), err
}

// List takes label and field selectors, and returns the list of Policies that match those selectors.
func (c *FakePolicies) List(opts v1.ListOptions) (result *policiesv1.PolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(policiesResource, policiesKind, c.ns, opts), &policiesv1.PolicyList{})
	...
	list := &policiesv1.PolicyList{ListMeta: obj.(*policiesv1.PolicyList).ListMeta}
	for _, item := range obj.(*policiesv1.PolicyList).Items {
...
func (c *FakePolicies) Create(policy *policiesv1.Policy) (result *policiesv1.Policy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(policiesResource, c.ns, policy), &policiesv1.Policy{})
...
func (c *FakePolicies) Update(policy *policiesv1.Policy) (result *policiesv1.Policy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(policiesResource, c.ns, policy), &policiesv1.Policy{})
...
func (c *FakePolicies) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(policiesResource, c.ns, name), &policiesv1.Policy{})
...
func (c *FakePolicies) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &policiesv1.PolicyList{})
	return err
}
...
func (c *FakePolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *policiesv1.Policy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(policiesResource, c.ns, name, pt, data, subresources...), &policiesv1.Policy{})
