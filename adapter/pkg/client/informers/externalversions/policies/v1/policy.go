...
import (
	...
	v1 "github.com/ibm-cloud-security/app-identity-and-access-adapter/adapter/pkg/client/listers/policies/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AppidV1().Policies(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppidV1().Policies(namespace).Watch(options)
			},
		},
		&policiesv1.Policy{},
		resyncPeriod,
...
func (f *policyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&policiesv1.Policy{}, f.defaultInformer)
}
